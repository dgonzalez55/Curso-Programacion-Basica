...
| Método                                                                                                                    | Descripción                                                                                                                                                                                                  | Ejemplo                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <p><code>.sort()</code></p><p> </p><p><code>.sort(reverse=True)</code></p><p> </p><p><code>.sort(key=function)</code></p> | Ordena los elementos de la lista _in-place_ (modifica la lista original). Si no se indica `reverse=True`, la ordenación es ascendente. Permite también personalizar la ordenación si se le pasa una función. | <p><code>lista = [2, 7, 2, 4]</code></p><p><code>lista.sort()</code></p><p><code>print(lista)</code> → <code>[2, 2, 4, 7]</code></p><p> </p><p><code>lista.sort(reverse=True)</code></p><p><code>print(lista)</code> → <code>[7, 4, 2, 2]</code> </p><p>  </p><p><code>palabras=["Hola","Pol"]</code>   </p><p><code>palabras.sort(key=len)</code></p><p><code>print(palabras)</code> → <code>["Pol","Hola"]</code></p> |
...
| Método                                                                      | Descripción                                                                                                                                         | Ejemplo                                                                                                                                                                                   |
| --------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <p><code>.get(key)</code></p><p> </p><p><code>.get(key, default)</code></p> | Devuelve el valor para una clave. A diferencia de `diccionario[clave]`, permite un valor por defecto si la clave no existe, evitando un `KeyError`. | <p> <code>alu= {"nombre": "Ana"}</code></p><p><code>print(alu.get("nombre"))</code> → <code>"Ana"</code></p><p> </p><p><code>print(alu.get("email", "N/A"))</code> → <code>N/A</code></p> |
